...
namespace CMD\Invoice;

use Exception;
use CMD\Invoice\Exceptions\ApiException;
use CMD\Invoice\Exceptions\NullDataException;
use CMD\Invoice\Exceptions\TestEnvironmentException;
use CMD\Invoice\Models\Invoice;
use CMD\Invoice\Models\UserInformations;
...
class InvoiceManagement
{
     ...
     *
     * @var CMD\Invoice\Models\Invoice
     */
    protected $invoice;
     ...
     * Invoices
     *
     * @var array CMD\Invoice\Models\Invoice
     */
    protected $invoices = [];
     ...
     * User Informations
     *
     * @var CMD\Invoice\Models\UserInformations
     */
     ...
     * @return CMD\Invoice\InvoiceManager
     */
    ...
    {
        $response = $this->client->post($this->getBaseUrl() . "InvoiceManagement.php", [
     ...
     *
     * @return CMD\Invoice\Models\Invoice
     */
     ...
     *
     * @return array CMD\Invoice\Models\Invoice
     */
    ...
    public function getInvoicePDF(Invoice $invoice = null, $signed = true)
    {
        ...
        $mpdf = new Mpdf();
        $mpdf->WriteHTML($data);
        return $mpdf->Output('test.pdf', Destination::STRING_RETURN);
    }
     ...
     *
     * @param CMD\Invoice\Models\UserInformations $userInformations
     * @return CMD\Invoice\Models\Invoice
     */
     ...
     *
     * @return CMD\Invoice\Models\UserInformations
     */
